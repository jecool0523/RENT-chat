          ...
          >
            ...
            <div className="mt-auto border-t border-zinc-200/60 px-3 py-3 dark:border-zinc-800">
              ...
              <div className="mt-2 flex items-center gap-2 rounded-xl bg-zinc-50 p-2 dark:bg-zinc-800/60">
                <div className="grid h-8 w-8 place-items-center rounded-full text-xs font-bold text-white dark:bg-destructive dark:text-zinc-900 bg-primary">
                  ID
                </div>
                <div className="min-w-0">
                  <div className="truncate text-sm font-medium">사용자</div>
                  <div className="truncate text-xs text-zinc-500 dark:text-zinc-400">Character chat</div>
                </div>
              </div>
            </div>
          </motion.aside>
